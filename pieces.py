...
#     try:
#         pdf_bytes = generate_pdf_file(form_data)
#         return Response(
#             content=pdf_bytes,
...
#         pdf_bytes = generate_pdf_file(form_data)
#         file_url = upload_pdf_to_s3(form_data, pdf_bytes)
...
# #         form_query = """
# #             INSERT INTO forms (form_id, employee_name, requestor_name, request_date, service_week_start, service_week_end, status)
...
# #             parse_date(form_data.requestDate),
# #             parse_date(form_data.serviceWeek['start']),
# #             parse_date(form_data.serviceWeek['end']),
# #             'pending'
# #         ))

# #         schedule_query = """
# #             INSERT INTO schedules (form_id, day, date, time, location)
# #             VALUES (%s, %s, %s, %s, %s)
# #         """

# #         for item in form_data.schedule:
# #             if item.get('time') and item.get('location'):
